...
import { Home, BookOpen, ChevronLeft, TrendingUp, TrendingDown, DollarSign, ChevronRight, PieChart, User } from 'lucide-react'
import { useState } from 'react'
import { AreaChart, Area, ResponsiveContainer } from 'recharts'

interface SavingsJournalScreenProps {
  isOpen: boolean
  onClose: () => void
  goalAmount: number
  goalDescription: string
  onExpenseAnalysisClick: () => void
}
...
export default function SavingsJournalScreen({ isOpen, onClose, goalAmount, goalDescription, onExpenseAnalysisClick }: SavingsJournalScreenProps) {
      ...
      <div className="sticky top-0 z-10 bg-white border-b border-gray-200 shadow-sm">
        ...
        <div className="flex items-center justify-between px-6 py-4">
          ...
          <div className="flex items-center gap-2">
            <div className="w-8 h-8 bg-gradient-to-br from-[#a78bfa] to-[#6ee7b7] rounded-lg flex items-center justify-center">
      ...
      <div className="h-[calc(100vh-180px)] overflow-y-auto bg-gray-50">
        {activeTab === 'home' && (
          <div className="flex items-center justify-center h-full">
            <p className="text-lg text-gray-500">홈페이지 (준비중)</p>
          </div>
        )}
        ...
        {activeTab === 'journal' && (
          <div className="pb-24">
            ...
            <div className="bg-white px-6 py-4 border-b border-gray-100">
              ...
              <p className="text-xl font-bold text-gray-900">{goalDescription}</p>
            </div>
            ...
            <div className="px-6 pb-6">
              <div className="bg-white rounded-3xl p-6 border border-gray-100">
                <div className="flex items-center justify-between mb-4">
                  ...
                  <button
                    onClick={onExpenseAnalysisClick}
        ...
        <div className="flex items-center justify-around max-w-2xl mx-auto">
          <button 
            ...
            className={`flex flex-col items-center gap-1 py-2 px-4 ${
              activeTab === 'home' ? 'text-[#a78bfa]' : 'text-gray-400 hover:text-gray-900'
            }`}
          >
